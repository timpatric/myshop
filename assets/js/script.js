...
$(document).on('click','#mobile_btn',function(){
    ...
    $('html').addClass('menu-opened');return false;
});
$(".sidebar-overlay").on("click",function(){$wrapper.removeClass('slide-nav');
...
// datetimepicker javascript file
...
//         height:'auto',width:'100%',position:'right',size:'7px',color:'#ccc',allowPageScroll:false,wheelStep:10,touchScrollStep:100});
//         var wHeight=$(window).height()-60;$slimScrolls.height(wHeight);
...
//         var targ=$(e.target).closest('.sidebar').length;if(targ){
